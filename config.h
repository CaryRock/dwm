...
static const char *fonts[]          = { "Noto Sans Mono:antialias=true:autohint=true:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
...
static const char scratchpadname[] = "scratchpad";
static const char *scratchpadcmd[] = { "alacritty", "-T", scratchpadname, "-o", "window.dimensions: {120,34}", NULL };
